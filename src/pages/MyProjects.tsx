...
function MyProjects() {
  ...
  const imgClassBig = "imgNoTrim";
  
  const classNameArr: Array<ClassName> = [];
  ...
  const charBoxes = classNameArr.map((arrElem) => 
    <div className={arrElem.className} tabIndex={arrElem.index}><img className='bannerImg' src={img1} alt="Logo" onMouseEnter={() => {}} onMouseLeave={() => {}}/></div>
  )

    return (
      <>
      <h2 className="wordGuessTitle">View my projects below!</h2>
      ...
      <div className='pictureBanner'>
        <div className={imgClass} style={{}}><img className='bannerImg' src={img1} alt="Logo" onMouseEnter={() => {}} onMouseLeave={() => {}}/></div>
        {/* <div className={imgClass} style={{width: 900, zIndex: 1}}><img className='bannerImg' src={img1} alt="Logo" onMouseEnter={() => {}} onMouseLeave={() => {}}/></div> */}
        <div className={imgClass}><img className='bannerImg' src={img2} alt="Logo" /></div>
        <div className={imgClass}><img className='bannerImg' src={img3} alt="Logo" /></div>
        <div className={imgClassBig}><img className='bannerImg' src={img2} alt="Logo" /></div>
        <div className={imgClass}><img className='bannerImg' src={img1} alt="Logo" /></div>
      </div>
