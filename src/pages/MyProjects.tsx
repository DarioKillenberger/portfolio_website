  ...
  function mouseHover(elemIndex:number) {
    ...
    return (
      ...
      <div className='pictureBanner'>
        <div className={activeImg === 1 ? imgClassSelected : imgClass}><img className='bannerImg' src={img1} alt="Logo" onMouseEnter={() => mouseHover(1)} onMouseLeave={() => {mouseHover(0)}}/></div>
        <div className={activeImg === 2 ? imgClassSelected : imgClass}><img className='bannerImg' src={img2} alt="Logo" onMouseEnter={() => mouseHover(2)} onMouseLeave={() => {mouseHover(0)}}/></div>
