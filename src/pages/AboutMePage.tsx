    ...
    let aboutMeArr: AboutMe[] = [
        {
            ...
            details: "",
            contents: [
                "Having recently graduated from my Bachelor of Software Engineering at RMIT University, I love building software that meshes with hardware, as well as working on cool projects in the ML/AI space.",
                "Having completed a one-year internship as a Junior Test Analyst, I am keen to apply my existing knowledge to make a real, positive impact on the world, while learning so much more.",
            ]
        },
        {
            title: "Experience:",
            year: "06/2023 - 06/2024",
        ...
        },
        {
            ...
            details: "Secretary/President/Treasurer - RMIT Cycling Club (Volunteer)",
            contents: [
        ...
        {
            title: "Education",
            year: "07/2021 - 12/2025",
            details: "Bachelor of Software Engineering - RMIT University",
            contents: [
                "Recently completed my degree with a GPA of 3.3/4",
            ]
        },
        {
            title: "",
        ...
        <>
            <div className='aboutMeWrapper'>
                ...
                >
                    ...
                    <h2>I'm a software engineer, doer, creative thinker, and have a few too many side hobbies.</h2>
